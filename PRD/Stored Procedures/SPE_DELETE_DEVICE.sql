...
-- =============================================
CREATE PROCEDURE    [PRD].[SPE_DELETE_DEVICE]
	@XML_RESULT		  XML = '' OUT  ,      --0 TO ERROR AND 1 TO CORRECT
	@PIN_ID_DEVICE AS int, 
...
BEGIN
	...
	BEGIN TRY		   			
		...
		DELETE FROM PRD.C_DEVICE_METRICS
		WHERE ID_DEVICE = @PIN_ID_DEVICE

		DELETE FROM PRD.C_DEVICE
		WHERE [ID_DEVICE] = @PIN_ID_DEVICE
		...
		SET @XML_RESULT = DBO.F_ERROR_INSERT_MESSAGES(@XML_RESULT, 'Successfully deleted Device', 'EN')
