...
-- =============================================
CREATE PROCEDURE    [PRD].[SPE_DELETE_PALLET_COMMENT]
	@XML_RESULT		  XML = '' OUT  ,      --0 TO ERROR AND 1 TO CORRECT
	@PIN_ID_PALLET_COMMENT AS int, 
...
BEGIN
	...
	BEGIN TRY		   			
		...
		IF @PIN_ID_PALLET IS NOT NULL
			BEGIN
					DELETE FROM PRD.K_PALLET_COMMENT
