...
-- =============================================
CREATE PROCEDURE    [PRD].[SPE_DELETE_PALLET]
	@XML_RESULT		  XML = '' OUT  ,      --0 TO ERROR AND 1 TO CORRECT
	@PIN_ID_PALLET AS int, 
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--DELETE THE REGISTER ON THE SQL TABLE PRD.C_K_PALLET
		DELETE FROM PRD.K_NOTIFICATION_PROCESS 
		 WHERE ID_NOTIFICATION_REFERENCE = @PIN_ID_PALLET 
		   AND KY_NOTIFICATION_ORIGIN = 'PALLET'
		...
		SET @XML_RESULT = DBO.F_ERROR_INSERT_MESSAGES(@XML_RESULT, 'Successfully deleted pallet', 'EN')
