...
-- =============================================
-- 22/07/2018	JDR	A clause is added to the join with the table ADM.C_CUSTOMER_SAMPLES to also filter by the customer number
-- =============================================

CREATE PROCEDURE    [PRD].[SPE_GET_K_FORMS]
...
AS
	...
	FROM PRD.K_WORK_ORDER WO
		...
		LEFT JOIN ADM.C_CUSTOMER_SAMPLES CS 
			...
			AND CS.KY_CUSTOMER = WO.KY_CUSTOMER
