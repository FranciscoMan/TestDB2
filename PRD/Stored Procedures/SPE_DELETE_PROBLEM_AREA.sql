...
-- Description: Delete a problem area
-- =============================================
CREATE PROCEDURE    [PRD].[SPE_DELETE_PROBLEM_AREA]
	@XML_RESULT XML = '' OUT  ,      --0 TO ERROR AND 1 TO CORRECT
	@PIN_ID_PROBLEM_AREA AS int, 
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--DELETE THE REGISTER ON THE SQL TABLE PRD.C_PROBLEM_AREA
		DELETE FROM PRD.C_PROBLEM_AREA
		...
		SET @XML_RESULT = DBO.F_ERROR_INSERT_MESSAGES(@XML_RESULT, 'Successfully deleted problem area', 'EN')
