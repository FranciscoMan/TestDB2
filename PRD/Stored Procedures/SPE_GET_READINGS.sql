...
-- =============================================
-- 25/02/2018 JDR Units added for numeric values
-- 25/02/2018 GVT Add Test T column 
...
-- =============================================
CREATE PROCEDURE    [PRD].[SPE_GET_READINGS] 
	...
	,@PIN_CL_STATUS_READINGS NVARCHAR(20) =NULL
AS   
	...
	SELECT 			  
		...
		, CASE XML_METRICS_VALUE.value('(/FIELD_TYPES/@FIELD_TYPE)[1]', 'NVARCHAR(20)') WHEN 'NUMERICBOX' THEN
			CASE WHEN NULLIF(XML_METRICS_VALUE.value('(/FIELD_TYPES/@UPPER_LIMIT)[1]', 'NVARCHAR'), '') IS NOT NULL  AND NULLIF(XML_METRICS_VALUE.value('(/FIELD_TYPES/@NOMINAL_VALUE)[1]', 'NVARCHAR'), '') IS NOT NULL THEN		-- LIMITS EXISTS
		...
		, CASE XML_METRICS_VALUE.value('(/FIELD_TYPES/@FIELD_TYPE)[1]', 'NVARCHAR(20)') WHEN 'NUMERICBOX' THEN
			CASE WHEN NULLIF(XML_METRICS_VALUE.value('(/FIELD_TYPES/@LOWER_LIMIT)[1]', 'NVARCHAR'), '') IS NOT NULL AND NULLIF(XML_METRICS_VALUE.value('(/FIELD_TYPES/@NOMINAL_VALUE)[1]', 'NVARCHAR'), '') IS NOT NULL THEN		-- LIMITS EXISTS
				CASE XML_METRICS_VALUE.value('(/FIELD_TYPES/@HYSTERESIS)[1]', 'NVARCHAR(20)')
		...
		, CASE XML_METRICS_VALUE.value('(/FIELD_TYPES/@FIELD_TYPE)[1]', 'NVARCHAR(20)')
			WHEN 'NUMERICBOX' THEN
				CASE WHEN NULLIF(XML_METRICS_VALUE.value('(/FIELD_TYPES/@LOWER_LIMIT)[1]', 'NVARCHAR'), '') IS NOT NULL 
					...
					CASE XML_METRICS_VALUE.value('(/FIELD_TYPES/@HYSTERESIS)[1]', 'NVARCHAR(20)')
						WHEN 'ABS' THEN 
							CASE WHEN XML_METRICS_VALUE.value('(/FIELD_TYPES/@FINISHED_VALUE)[1]', 'DECIMAL(20,7)') 
								BETWEEN XML_METRICS_VALUE.value('(/FIELD_TYPES/@LOWER_LIMIT)[1]', 'DECIMAL(20,7)') 
									AND XML_METRICS_VALUE.value('(/FIELD_TYPES/@UPPER_LIMIT)[1]', 'DECIMAL(20,7)') 
								THEN 'YES' 
								ELSE 'NO' 
							END
						WHEN 'PCT' THEN
							CASE WHEN XML_METRICS_VALUE.value('(/FIELD_TYPES/@FINISHED_VALUE)[1]', 'DECIMAL(20,7)') 
								BETWEEN XML_METRICS_VALUE.value('(/FIELD_TYPES/@NOMINAL_VALUE)[1]', 'DECIMAL(20,7)') * (1 - (XML_METRICS_VALUE.value('(/FIELD_TYPES/@LOWER_LIMIT)[1]', 'DECIMAL(20,7)') / 100))
									AND XML_METRICS_VALUE.value('(/FIELD_TYPES/@NOMINAL_VALUE)[1]', 'DECIMAL(20,7)') * (1 + (XML_METRICS_VALUE.value('(/FIELD_TYPES/@UPPER_LIMIT)[1]', 'DECIMAL(20,7)') / 100))
								THEN 'YES' 
								ELSE 'NO' 
							END
						WHEN 'REL' THEN
							CASE WHEN XML_METRICS_VALUE.value('(/FIELD_TYPES/@FINISHED_VALUE)[1]', 'DECIMAL(20,7)') 
								BETWEEN XML_METRICS_VALUE.value('(/FIELD_TYPES/@NOMINAL_VALUE)[1]', 'DECIMAL(20,7)') - XML_METRICS_VALUE.value('(/FIELD_TYPES/@LOWER_LIMIT)[1]', 'DECIMAL(20,7)')
									AND XML_METRICS_VALUE.value('(/FIELD_TYPES/@NOMINAL_VALUE)[1]', 'DECIMAL(20,7)') + XML_METRICS_VALUE.value('(/FIELD_TYPES/@UPPER_LIMIT)[1]', 'DECIMAL(20,7)')
								THEN 'YES' 
								ELSE 'NO' 
							END
						ELSE 'NA'
	...
	WHERE 
		...
		(@PIN_ID_PALLET IS NULL OR (KF.ID_PALLET = @PIN_ID_PALLET)) AND
		(@PIN_ID_FORM  IS NULL OR (KF.ID_FORM = @PIN_ID_FORM )) AND 
		(@PIN_CL_STATUS_READINGS IS NULL OR (KF.KY_STATUS_FORM = @PIN_CL_STATUS_READINGS))
