...
-- =============================================
CREATE PROCEDURE    [ADM].[SPE_DELETE_DEPARTMENT]
	 @XML_RESULT XML = '' OUT  ,      --0 TO ERROR AND 1 TO CORRECT
	@PIN_ID_DEPARTMENT AS int, 
...
BEGIN
	...
	BEGIN TRY		   			
		...
		SET @XML_RESULT = DBO.F_ERROR_INSERT_MESSAGES(@XML_RESULT, 'Successfully deleted department', 'EN')
