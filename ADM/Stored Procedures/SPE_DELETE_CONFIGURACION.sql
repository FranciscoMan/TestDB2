...
-- Description: Delete the configuratión
-- =============================================


CREATE PROCEDURE    [ADM].[SPE_DELETE_CONFIGURACION]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		DELETE FROM ADM.S_CONFIGURATION
		...
		SET @XML_RESULT = DBO.F_ERROR_INSERT_MESSAGES(@XML_RESULT, 'Successfully deleted configuration', 'EN')
