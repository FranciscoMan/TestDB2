...
-- Description: Delete a BRANCH_PLANT
-- =============================================
CREATE PROCEDURE    [ADM].[SPE_DELETE_BRANCH_PLANT]
	@XML_RESULT XML = '' OUT  ,      --0 TO ERROR AND 1 TO CORRECT
	@PIN_ID_BRANCH_PLANT AS int, 
	@PIN_STREAM_ID NVARCHAR(250),
...
BEGIN
	...
	BEGIN TRY		   			
		...
		DELETE FROM ADM.C_BRANCH_PLANT
		WHERE [ID_BRANCH_PLANT] = @PIN_ID_BRANCH_PLANT
				
		DELETE FROM ADM.FS_FILE_SYSTEM WHERE stream_id = @PIN_STREAM_ID
		...
		SET @XML_RESULT = DBO.F_ERROR_INSERT_MESSAGES(@XML_RESULT, 'Successfully deleted branch plant', 'EN')
