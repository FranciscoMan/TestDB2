...
-- Description: Delete a transition-branch plant relationship
-- =============================================
 CREATE PROCEDURE    [ADM].[SPE_DELETE_BRANCH_PLANT_TRANSITION]
	@XML_RESULT XML = '' OUT  ,      --0 TO ERROR AND 1 TO CORRECT
	@PIN_ID_BRANCH_PLANT_TRANSITION AS int, 
...
BEGIN
	...
	BEGIN TRY		   			
		...
		DELETE FROM [ADM].[C_BRANCH_PLANT_TRANSITION] WHERE ID_BRANCH_PLANT_TRANSITION = @PIN_ID_BRANCH_PLANT_TRANSITION
