...
-- =============================================
CREATE PROCEDURE    [ADM].[SPE_DELETE_CATALOG_VALUE]
	@XML_RESULT		  XML = '' OUT  ,      --0 TO ERROR AND 1 TO CORRECT
	@PIN_ID_CATALOG_VALUE AS int, 
...
BEGIN
	...
	BEGIN TRY		   			
		...
		DELETE FROM ADM.C_VALUE_CATALOG
		...
		SET @XML_RESULT = DBO.F_ERROR_INSERT_MESSAGES(@XML_RESULT, 'Se eliminó el valor satisfactoriamente', 'ES')
		SET @XML_RESULT = DBO.F_ERROR_INSERT_MESSAGES(@XML_RESULT, 'Successfully deleted value', 'EN')
